...
void Engine::draw_text(const char* msg, SDL_Rect rect, SDL_Renderer* ren)
{
...
void Engine::draw_image(const char* filename)
{
...
void Engine::music(const char* mp3)
{
...
void Engine::waitUntilKeyPressed(string word, string& mystery_word, bool& correct_guess, SDL_Rect mystery_rect, SDL_Renderer* ren)
{
    SDL_Event e;
            bool wait =true;
            while (wait) {
